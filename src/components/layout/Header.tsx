...
const Header = ({ title }: { title: string }) => {
  ...
  return (
    <header className={`sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border bg-background px-4 sm:px-6 ${collapsed ? "lg:ml-16" : "lg:ml-64"} transition-all duration-300`}>
      {isMobile && (
